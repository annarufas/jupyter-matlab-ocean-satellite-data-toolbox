function [nasaData] = ncreadTimeseriesNasaData(dirNasaDataRaw,...
    filenameNasaDataProcessed)

% NCREADTIMESERIESNASADATA Reads in the time-series data downloaded from
