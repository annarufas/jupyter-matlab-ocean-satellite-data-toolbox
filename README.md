...
> Rufas, A. (2025). annarufas/jupyter-matlab-ocean-satellite-data-toolbox: Tools to Access Satellite Ocean Data from Main Repositories (CMEMS, OC-CCI, BICEP, EUMETSAT, NASA Ocean Color and NOAA CoastWatch) (v1.1) [software]. Zenodo. https://doi.org/10.5281/zenodo.14193549.
